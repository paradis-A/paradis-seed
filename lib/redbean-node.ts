...
export class RedBeanNode {
    ...
    setup(
        dbType: string | knex = "sqlite",
        connection: StaticConnectionConfig = { filename: "./dbfile.db" },
        pool: PoolConfig = {}
    ) {
    ...
    findStream(
        ...
        return BeanConverterStream.createStream(
            type,
            this,
